                            ...
                            <div className="group relative">
                                <div className="relative flex items-center justify-center h-80 w-full overflow-hidden rounded-lg bg-white group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-64 lg:aspect-w-1 lg:aspect-h-1">
                                    <img
                                        ...
                                        alt="Candu"
                                        className="h-fit w-80 object-cover object-bottom"
                                    />
                                </div>
                            ...
                            <div className="group relative">
                                <div className="relative flex items-center justify-center h-80 w-full overflow-hidden rounded-lg bg-white group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-64 lg:aspect-w-1 lg:aspect-h-1">
                                    <img
                                        ...
                                        alt="Field Aviation"
                                        className="h-fit w-72 object-cover object-bottom"
                                    />
                                </div>
                                <h3 className="mt-6 text-sm text-gray-500">
                                    <a>
                            ...
                            <div className="group relative">
                                <div className="relative flex items-center justify-center h-80 w-full overflow-hidden rounded-lg bg-white group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-64 lg:aspect-w-1 lg:aspect-h-1">
                                    <img
                                        ...
                                        className="h-fit w-fit object-cover object-bottom"
                                    />
                                </div>
                                <h3 className="mt-6 text-sm text-gray-500">
                                    <a>
                            ...
                            <div className="group relative">
                                <div className="relative flex items-center justify-center h-80 w-full overflow-hidden rounded-lg bg-white group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-64 lg:aspect-w-1 lg:aspect-h-1">
                                    <img
                                        ...
                                        alt="Field Aviation"
                                        className="h-fit w-96 object-cover object-bottom"
                                    />
                                </div>
                                <h3 className="mt-6 text-sm text-gray-500">
                                    <a>
